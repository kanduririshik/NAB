...
export default function Register() {
  const { register, setToken, loginWithProvider } = useAuth();
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      ...
      // Initialize the session state as a new user with incomplete profile
      const mockUser = {
        id: registeredUser.id,
        email: registeredUser.email,
        role: 'customer',
        profileCompleted: false, // Forces onboarding redirect
      ...
      // Hard redirect to root which will redirect to /complete-profile
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-muted font-bold">Or Register manually</span>
              </div>
            </div>

            {/* Method 2: Manual signup form */}
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="email"
                    required
                    id="nab_register_email_input"
                    name="nab_register_email_input"
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                    placeholder="Enter your institutional email"
                    autoComplete="new-username"
                    className="block w-full pl-10 pr-4 py-2.5 bg-background border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm font-medium"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="password"
                    required
                    id="nab_register_password_input"
                    name="nab_register_password_input"
                    value={password}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="password"
                    required
                    id="nab_register_confirm_password_input"
                    name="nab_register_confirm_password_input"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full h-11 flex justify-center items-center gap-2 rounded-lg shadow-lg hover:shadow-primary/20 text-xs font-bold text-white bg-primary hover:bg-primary/95 transition-all cursor-pointer disabled:opacity-50 pt-1"
              >
                {loading ? (
                  <Loader2 className="animate-spin" size={16} />
                ) : (
                  <>
                    Sign Up & Continue <ArrowRight size={16} />
                  </>
                )}
              </button>
            </form>
            ...
            <form onSubmit={handleGoogleSubmit} className="space-y-4 text-left">
              <div>
                ...
                <input
                  type="email"
                  required
                  id="nab_google_register_email"
                  name="nab_google_register_email"
                  value={googleEmail}
